    ...
    public partial class LoginForm :XtraForm
    {
        ...
        private async void btn_Login_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dt2 =await SQLiteCrud.GetDataFromSQLiteAsync("SELECT UserName FROM AdminLogin WHERE UserName='" + username + "' AND UserPassword='" + password + "' LIMIT 1");
                if (dt2.Rows.Count <= 0)
                {
                ...
                else
                {
                    ...
                    fr.username = dt2.Rows[0][0].ToString();
                    fr.Show();
                    this.Hide();
                }
            }
